...
class TimelineContainer(Gtk.Grid, Zoomable, Loggable):
    ...
    def _createActions(self):
        ...
        self.app.shortcuts.add("timeline.zoom-in", ["<Control>plus", "<Control>equal"],
                                   _("Zoom in"))
        ...
        self.app.shortcuts.add("timeline.zoom-out", ["<Control>minus"], _("Zoom out"))
        ...
        self.app.shortcuts.add("timeline.zoom-fit", ["<Control>0"],
        ...
        self.app.shortcuts.add("timeline.play", ["space"], _("Play"))
